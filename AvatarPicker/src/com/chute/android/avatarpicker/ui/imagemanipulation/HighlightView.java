...
class HighlightView {
	...
	public int getHit(float x, float y) {
		...
		if (mCircle) {
			...
			/**
			 * verticalCheck makes sure the position is between the top and the
			 * bottom edge (with some tolerance). Similar for horizCheck.
			 */
	...
	/**
	 * Handles motion (dx, dy) in screen space. The "edge" parameter specifies
	 * which edges the user is dragging.
	 */
	...
	void growBy(float dx, float dy) {
		...
		/**
		 * Don't let the cropping rectangle grow too fast. Grow at most half of
		 * the difference between the image rectangle and the cropping
		 * rectangle.
		 */
