...
abstract class ImageViewTouchBase extends ImageView {
	...
	/**
	 * This function changes bitmap, reset base matrix according to the size of
	 * the bitmap, and optionally reset the supplementary matrix.
	 */
	...
	private void getProperBaseMatrix(RotateBitmap bitmap, Matrix matrix) {
		...
		/**
		 * We limit up-scaling to 2x otherwise the result may look bad if it's a
		 * small icon.
		 */
